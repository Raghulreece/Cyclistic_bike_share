...
```{r}
rm(list=ls())
df1<-read.csv("C:/Users/raghu/OneDrive/Documents/cyclistic-bike-share-analysis/t1.csv")
df2<-read.csv("C:/Users/raghu/OneDrive/Documents/cyclistic-bike-share-analysis/t2.csv")
df3<-read.csv("C:/Users/raghu/OneDrive/Documents/cyclistic-bike-share-analysis/t3.csv")
df4<-read.csv("C:/Users/raghu/OneDrive/Documents/cyclistic-bike-share-analysis/t4.csv")
df5<-read.csv("C:/Users/raghu/OneDrive/Documents/cyclistic-bike-share-analysis/t5.csv")
df6<-read.csv("C:/Users/raghu/OneDrive/Documents/cyclistic-bike-share-analysis/t6.csv")
df7<-read.csv("C:/Users/raghu/OneDrive/Documents/cyclistic-bike-share-analysis/t7.csv")
df8<-read.csv("C:/Users/raghu/OneDrive/Documents/cyclistic-bike-share-analysis/t8.csv")
df9<-read.csv("C:/Users/raghu/OneDrive/Documents/cyclistic-bike-share-analysis/t9.csv")
df10<-read.csv("C:/Users/raghu/OneDrive/Documents/cyclistic-bike-share-analysis/t10.csv")
df11<-read.csv("C:/Users/raghu/OneDrive/Documents/cyclistic-bike-share-analysis/t11.csv")
df12<-read.csv("C:/Users/raghu/OneDrive/Documents/cyclistic-bike-share-analysis/t12.csv")
```
...
str(df12)
```
##converting start_station_id,end_station_id as integer so that they can join apparently without mismatching
...
str(all_trips)
```
##changing the ridelength into numeric
```{r}
...
```
##using geom col visualizing graph for the weekday 
```{r}
new_trips_v2 %>%mutate(weekday=wday(started_at, label=TRUE))%>%
  group_by(member_casual,weekday)%>%
...
```
##using geom col visualizing graph for the month
